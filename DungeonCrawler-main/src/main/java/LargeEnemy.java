/**
 ...
 Description:
 Implements the Character interface. Represents a Large enemy. Health increases every floor.
 You fight one every 10 floors.
 */
public class LargeEnemy implements Character {
    double health = 200;
    ...
    /**
     ...
     Description: Constructor for the large Enemy.
     */
    public LargeEnemy(int floor) {
        setName("Belthazar, King of the Ogres");
        setRace(Race.ORC);
    ...
    public double specialMove() {
        if (this.stamina >= 50) {
            ...
            System.out.println(this.name + " did not have enough Stamina to use a special attack, "
                    + "and used a regular attack");
            return strength * 10;
        }
    }
    /**
