/**
 ...
 Implements the Character interface. Is a unique character class that has less health,
 High Speed, and more damage.
 */
public class Assassin implements Character {
    ...
    /**
     ...
     Description:
     Creates a new Assassin Character, Buffs character based on Race.
     */
    public Assassin(String name, Race race) {
        setName(name);
        switch (race) {
            case DWARF:
                this.defense += 2;
