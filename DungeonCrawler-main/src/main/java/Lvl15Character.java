/**
 Class: Lvl15Character

 Description:
 Part of the Decorator Design Pattern.
 Extends CharacterDecorator Abstract Class.
 Is used to wrap the character class when the character levels up to level 15.
 Implements a unique Special move.
 */
public class Lvl15Character  extends CharacterDecorator {
    /**
     Method: Lvl15Character
     Inputs: Character decoratedCharacter
     Returns: None

     Description: Constructor for the Lvl15Character player.
     */
    public Lvl15Character(Character decoratedCharacter) {
