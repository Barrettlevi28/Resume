/**
 Class: Lvl10Character

 Description:
 Part of the Decorator Design Pattern.
 Extends CharacterDecorator Abstract Class.
 Is used to wrap the character class when the character levels up to level 10.
 Implements a unique Special move.
 */
public class Lvl10Character extends CharacterDecorator {
    /**
     Method: Lvl10Character
     Inputs: Character decoratedCharacter
     Returns: None

     Description: Constructor for the Lvl10Character player.
     */
    public Lvl10Character(Character decoratedCharacter) {
    ...
    /**
     ...
     Changed to do even more damage and take away even more stamina.
     */
    @Override
